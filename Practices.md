...
>   [1.3.3	Nepoužívat strážní ověřovací metody (tzv. Guard
>   Assertion)	8](#_Toc66385774)
...
>   [1.7.1	Odchytávat testované výjimky pomocí nástrojů knihoven či testovacích
>   frameworků	13](#_Toc66385790)

>   [1.7.2	Stanovovat obecnou úroveň pro výjimky testovací
>   metody	13](#_Toc66385791)

>   [1.8	Podmíněná logika	13](#_Toc66385792)

>   [1.8.1	Nepoužívat bloky if, else, switch, for či while v rámci
>   testu	14](#_Toc66385793)
...
>   [1.10.2	Ukládat testy pro jeden testovaný systém na jedno
>   místo	19](#_Toc66385807)
...
>   [2.2.3	Provádět křížovou kontrolu s pomocí jiných
>   prostředků	28](#_Toc66385831)

>   [2.2.4	Vynucovat chybné podmínky	28](#_Toc66385832)

>   [2.2.5	Používat jednotkové testy pro měření výkonových charakteristik
>   testovaného systému	28](#_Toc66385833)
...
obr. 5 Myšlenková mapa zachycující rozpad nejlepších postupů do skupin a
podskupin (autor)
